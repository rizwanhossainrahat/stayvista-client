            ...
            >
              <DialogPanel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                ...
                <div className='mt-2 w-full'>
                    {/* Update room form */}
                <UpdateRoomForm handleSubmit={handleSubmit} dates={dates} handleDates={handleDates} roomData={roomData} loading={loading} setRoomData={setRoomData} handleImage={handleImage}></UpdateRoomForm>
                </div>
                <hr className='mt-8 ' />
                <div className='mt-2 '>
                  <button
